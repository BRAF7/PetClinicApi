        ...
        <div className='MenuVeterinaria'>
            ...
            <div className="botones" id="navbarNavAltMarkup">
                ...
                <div className="">
                    ...
                    <NavLink exact activeClassName="active" to="/auth/login" className="btn btns"> Login </NavLink>
                    <NavLink exact activeClassName="active" to="/auth/me" className="btn btns"> Me </NavLink>
                </div>
            </div>
        </nav>
        </div>
