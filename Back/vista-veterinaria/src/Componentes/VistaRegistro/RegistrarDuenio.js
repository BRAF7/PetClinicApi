                    ...
                    <div className="divform">
                        <div className="row">
                            <div className="col">
                                ...
                                <input className='form-control texto' id='password' type="password"
                            ...
                            <div className="col">
                                ...
                                <input className='form-control texto' id='confirmPassword' type="password"
