...
import 'package:prueba_api_rest/Duenno/Model/owner_model.dart';
import 'package:prueba_api_rest/Duenno/Repository/list_owner_repository.dart';
import 'package:prueba_api_rest/Duenno/Views/add_duenno_view.dart';
import 'package:prueba_api_rest/controller/owner_controller.dart';

import '../Duenno/Views/edit_duenno.dart';
...
class _ListOwnersViewState extends State<ListOwnersView> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: ScaffoldDuenno(listOwnerController, context),
    );
  }
